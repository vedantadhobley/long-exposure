...
| **3 — Tiered numeric baselines** ◀ NEXT | extend daily cagg retention/refresh (30→~400 d) + `BaselineProvider` abstraction + refactor `VolumeDeviationScorer` onto it (multi-resolution window plumbing; monthly *numeric* cagg deferred — no months of data yet) | ~1 day (Thu) |
